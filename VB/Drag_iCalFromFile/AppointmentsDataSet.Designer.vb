    ...
    Partial Public Class AppointmentsDataSet
        ...
        Partial Public Class AppointmentsRow
            ...
            Public Property ID() As Integer
                Get
                    Return (CInt((Me(Me.tableAppointments.IDColumn))))
                End Get
            ...
            Public Property ResId() As Integer
                Get
                    Try
                        Return (CInt((Me(Me.tableAppointments.ResIdColumn))))
            ...
            Public Property EventType() As Integer
                Get
                    Try
                        Return (CInt((Me(Me.tableAppointments.EventTypeColumn))))
                    Catch e As Global.System.InvalidCastException
...
Namespace Drag_iCalFromFile.AppointmentsDataSetTableAdapters
    ...
    Partial Public Class AppointmentsTableAdapter
        ...
        Public Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_ResId? As Integer, ByVal Original_Status? As Integer, ByVal Original_Subject As String, ByVal Original_Label? As Integer, ByVal Original_StartTime? As Global.System.DateTime, ByVal Original_EndTime? As Global.System.DateTime, ByVal Original_Location As String, ByVal Original_AllDay As Boolean, ByVal Original_EventType? As Integer) As Integer
            ...
            If (Original_ResId.HasValue = True) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(2).Value = (CInt(Original_ResId.Value))
            Else
            ...
            If (Original_EventType.HasValue = True) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(18).Value = (CInt(Original_EventType.Value))
            Else
        ...
        Public Overridable Function Insert(ByVal ResId? As Integer, ByVal Status? As Integer, ByVal Subject As String, ByVal Description As String, ByVal Label? As Integer, ByVal StartTime? As Global.System.DateTime, ByVal EndTime? As Global.System.DateTime, ByVal Location As String, ByVal AllDay As Boolean, ByVal EventType? As Integer, ByVal RecurrenceInfo As String, ByVal ReminderInfo As String) As Integer
            If (ResId.HasValue = True) Then
                Me.Adapter.InsertCommand.Parameters(0).Value = (CInt(ResId.Value))
            Else
                Me.Adapter.InsertCommand.Parameters(0).Value = Global.System.DBNull.Value
            End If
            If (Status.HasValue = True) Then
                Me.Adapter.InsertCommand.Parameters(1).Value = (CInt(Status.Value))
            Else
            ...
            If (EventType.HasValue = True) Then
                Me.Adapter.InsertCommand.Parameters(9).Value = (CInt(EventType.Value))
            Else
        ...
        Public Overridable Function Update(ByVal ResId? As Integer, ByVal Status? As Integer, ByVal Subject As String, ByVal Description As String, ByVal Label? As Integer, ByVal StartTime? As Global.System.DateTime, ByVal EndTime? As Global.System.DateTime, ByVal Location As String, ByVal AllDay As Boolean, ByVal EventType? As Integer, ByVal RecurrenceInfo As String, ByVal ReminderInfo As String, ByVal Original_ID As Integer, ByVal Original_ResId? As Integer, ByVal Original_Status? As Integer, ByVal Original_Subject As String, ByVal Original_Label? As Integer, ByVal Original_StartTime? As Global.System.DateTime, ByVal Original_EndTime? As Global.System.DateTime, ByVal Original_Location As String, ByVal Original_AllDay As Boolean, ByVal Original_EventType? As Integer) As Integer
            If (ResId.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(0).Value = (CInt(ResId.Value))
            Else
                Me.Adapter.UpdateCommand.Parameters(0).Value = Global.System.DBNull.Value
            End If
            If (Status.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(1).Value = (CInt(Status.Value))
            Else
            ...
            If (EventType.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(9).Value = (CInt(EventType.Value))
            Else
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(12).Value = (CInt(Original_ID))
            If (Original_ResId.HasValue = True) Then
                Me.Adapter.UpdateCommand.Parameters(13).Value = (CObj(0))
                Me.Adapter.UpdateCommand.Parameters(14).Value = (CInt(Original_ResId.Value))
            Else
            ...
            If (Original_Status.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(16).Value = (CInt(Original_Status.Value))
            Else
            ...
            If (Original_Label.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(20).Value = (CInt(Original_Label.Value))
            Else
            ...
            If (Original_EventType.HasValue = True) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(30).Value = (CInt(Original_EventType.Value))
            Else
